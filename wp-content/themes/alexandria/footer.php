    ...
    <div class="footer-social">
    	...
    	<div class="responsive-container">
                                    ...
                                    <ul class="footer-social-icons">
                                        ...
                                        <li><a href="<?php echo esc_url( of_get_option('stumble_id') ); ?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/stumble.png" alt="stumble upon" /></a></li>
                                        <?php endif; ?>
                                        ...
                                        <li><a href="<?php echo esc_url( of_get_option('google_id') ); ?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/gplus.png" alt="google plus" /></a></li>
                                        <?php endif; ?>
